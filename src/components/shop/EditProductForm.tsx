...
import { ArrowLeft, X, Loader2, Upload, RefreshCw } from "lucide-react";
...
export default function EditProductForm({ productId }: EditProductFormProps) {
  ...
  const fetchProduct = async () => {
    try {
      ...
      form.reset({
        ...
        healthCertificate: product.healthCertificate || "",
      });
  ...
  const handleImageUpload = async (file: File, replaceIndex?: number) => {
    ...
    try {
      ...
      if (replaceIndex !== undefined) {
        ...
        newUrls = imageUrls.map((url, idx) => (idx === replaceIndex ? data.url : url));
      } else {
        // Add new image
        newUrls = [...imageUrls, data.url];
      }
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>, replaceIndex?: number) => {
    ...
    if (file) {
      ...
      handleImageUpload(file, replaceIndex);
    }
    // Reset input
    e.target.value = "";
  };
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., Persian, Siamese" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., Orange, White" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
